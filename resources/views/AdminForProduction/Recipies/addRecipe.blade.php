        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Create new recipe </h1>
                            ...
                            <form class="row g-3" method="POST" action="{{ route('addrecipies') }}">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name='recipe_name' placeholder="Insert recipe name"
                                            class="form-control" id="validationDefault01" value="" required>
                                    </div>
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name='recipe_code' class="form-control"
                                            id="validationDefault02" value="" placeholder="Insert recipe SKU " required>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name='recipe_code' class="form-control"
                                            id="validationDefault02" value="" placeholder="Insert recipe week "
                                            required>
                                    </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault02" value=""
                                        placeholder="Insert ingredient " required>
                                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright 2023&copy; Designed by <a class="app-link"
                                href="https://ypprogrammer.com/" target="_blank"> <img style="width: 100px;"
                                    src="assets/img/YP_logo_negro.png" alt="Yefferson Perez developer " srcset=""></a>
                        </div>
