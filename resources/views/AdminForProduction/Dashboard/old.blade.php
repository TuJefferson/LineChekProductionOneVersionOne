...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a style="display:none" class=" dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
            role="button" aria-expanded="false"></a>
        <!-- Sidebar Toggle-->
        <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"> <img style="height: 32px
        " src="assets/img/factor-logo-piso.png" alt="user profile"></button>
        <!-- Navbar Search-->
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body"> Records processed by the first shift
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body"> Records processed by the second shift
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body"> Records processed successfully

                                    <button type="button" class="btn btn-success">47</button>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"> Verification line</h5>
                                    <p class="card-text">Access the module to start the verification of inputs required
                                        to run the line.</p>
                                    <a href="#" class="btn btn-primary">Press here</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Access to the module that allows you to add, edit and delete
                                        recipes.</p>
                                    <a href="#" class="btn btn-primary">Press here</a>
                                </div>
                            </div>
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">DataTable Example</li>
                    </ol>
