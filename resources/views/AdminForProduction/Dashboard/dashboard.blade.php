              ...
              <div class="card  mb-4">
                  ...
                  <div class="card-footer d-flex ">
                      <div class="d-grid gap-2 d-md-flex ">
                          <h2>Recipes created successfully: <span class="badge bg-secondary"> {{count($recipes)}}</span>
                          </h2>
                      </div>
                  </div>
              </div>
      ...
      <div class="row">
          ...
          <div class="col-xl-3 col-md-6">
              <div class="card  mb-4">
                  ...
                  <div class="card-footer d-flex  justify-content-md-end">
                      <div class="d-grid gap-2 d-md-flex ">
                          <button class="btn btn-dark" type="button"> {{count($allShift)}}</button>
                      </div>
                  </div>
              </div>
          </div>
