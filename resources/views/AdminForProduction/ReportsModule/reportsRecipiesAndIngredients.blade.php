...
<head>
    ...
    <title>Admin Line Runing Production One (Reports Recipes and Ingredients)</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"> Reports recipes</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">All data processed in the recipe module</li>
                    </ol>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatable" class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($ingredients as $key => $recipeingredient)

                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>{{ $recipeingredient->recipe->recipe_code }}</td>
                                        <td>{{ $recipeingredient->recipe->recipe_name }}</td>
                                        <td>{{ $recipeingredient->ingredient_recipe_name }}</td>
